...
class SecondScreen extends Component{
	...
	state = {director: 'Lala', title:'Band'}
	...
	*/	
	editMovie(title, director, id){
		this.props.editAction(title,director,id);
	...
	render(){
		...
		return (
			...
			<Button
              onPress={() => this.editMovie(title, director, id)}
              title="Go home"
            />
			<AreaChart
                    style={ { height: 200 } }
